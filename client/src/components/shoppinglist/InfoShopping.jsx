...
import deleteOrEditActivity from '../../assets/deleteeditshoppinglist.gif'
        ...
        >
            ...
            <Modal.Body style={{ minHeight: 200, maxHeight: '90vh' }}>
                ...
                <li style={{ marginBottom: 20 }}>
                    This is the shopping list page. Here you can see what you have to buy and when.
                </li>
                ...
                <li>
                    If you want to delete an item from your shopping list, swipe left on the activity and click on the trash icon.
                </li>
                <li>
                    If you want to edit an item from your shopping list, swipe right on the activity and click on the edit icon.
                </li>
                <li>
